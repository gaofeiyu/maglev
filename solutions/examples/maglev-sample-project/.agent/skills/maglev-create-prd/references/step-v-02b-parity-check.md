...
description: '文档平价检查 - 分析非标准 PRD 并识别差距以达到 BMAD PRD 平价'
...
分析非标准 PRD 并识别差距以达到 BMAD PRD 平价，向用户展示关于如何继续的选项。
...
你的 PRD 缺少 6 个核心 BMAD PRD 部分中的 {count} 个。达到 BMAD 标准的总体工作量是：**{effort level}**
