...
description: 当运行或恢复 Maglev create-prd 工作流以通过基于步骤的过程生成 PRD 和验证报告时使用。
---

# 创建 PRD

## 概览
运行 Maglev create-prd 工作流以生成 PRD（创建、编辑和验证模式）。严格遵循步骤文件，通过正确的子流程并尊重所有菜单选项。

## 何时使用
- 用户要求运行或恢复 create-prd 工作流
- 你需要使用 Maglev 步骤生成 PRD，包括验证

## 何时**不**使用
- 用户想要快速的需求摘要，而不需要 Maglev 工作流
- 你不在 Maglev 项目上下文中
